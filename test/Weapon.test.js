  ...
  describe("Constructor tests", () => {
    ...
    describe("Initialization test", () => {
      it("Initialization test", async () => {
        ...
        expect(await weaponContractInstance.tokenURI()).to.equal(
          weaponTokenURI
        );
    ...
    describe("Safe Mint tests", () => {
      ...
      it("Should mint a Weapon with correct name", async () => {
        await rubieContractInstance.approve(
          weaponContractInstance.address,
          100
        );
        ...
        const recipientBalanceOf_before =
          await weaponContractInstance.balanceOf(_recipient);
    ...
    describe("Mint Legendary Weapon tests", () => {
      ...
      it("Should mint a Legendary Weapon", async () => {
        ...
        expect(legendaryWeaponMetadata.attackPoints).to.be.equals(
          _attackPoints
        );
